...
const texts: LocalizationData = {
  ru: {
    ...
    landing_description: "Tele•Ga — это маркетплейс, который позволяет создавать магазины, управлять клиентами и зарабатывать через рефералов прямо в Telegram.",
  ...
  uz: {
    ...
    landing_description: "Tele•Ga — bu Telegram'da do'konlar yaratish, mijozlarni boshqarish va taklifnomalar orqali daromad qilish imkonini beruvchi bozor.",
  ...
  kz: {
    ...
    landing_description: "Tele•Ga — бұл Telegram'да дүкендер құруға, тұтынушыларды басқаруға және рефералдар арқылы табыс табуға мүмкіндік беретін маркетплейс.",
  ...
  ua: {
    ...
    landing_description: "Tele•Ga — це маркетплейс, який дозволяє створювати магазини, керувати клієнтами та заробляти через рефералів прямо в Telegram.",
  ...
  am: {
    ...
    landing_description: "Tele•Ga-ն մարկետփլեյս է, որը թույլ է տալիս ստեղծել խանութներ, կառավարել հաճախորդներին և վաստակել հաշվարկների միջոցով հենց Telegram-ում:",
  ...
  ky: {
    ...
    landing_description: "Tele•Ga — бул Telegram'да дүкөн түзүүгө, кардарларды башкарууга жана рефералдар аркылуу киреше табууга мүмкүндүк берген маркетплейс.",
  ...
  en: {
    ...
    landing_description: "Tele•Ga is a marketplace that lets you create shops, manage clients, and earn through referrals directly in Telegram.",
    open_app: "Open App",
